...
export default async function CoursesPage() {
  try {
    // First await cookies to fix the error
    await cookies();
    // Get Auth0 session
      ...
      return (
        <div className="container mx-auto py-8 px-4">
          <div className="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-6">
            <p>An error occurred while loading your courses. Please try again later.</p>
          </div>
        </div>
      );
    }
    ...
    return (
      <div className="container mx-auto py-8 px-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/new" className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded">
            Add New Course
          </Link>
        </div>
        ...
        {courses && courses.length > 0 ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            <h2 className="text-xl font-medium mb-4">You don&apos;t have any courses yet</h2>
            <p className="text-gray-600 mb-6">Get started by adding your first course and uploading a syllabus.</p>
            <Link href="/new" className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded inline-block">
