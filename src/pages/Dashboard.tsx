    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-grow">
        <div className="container py-8">
          ...
          {/* Course list */}
          <h2 className="text-xl font-semibold tracking-tight leading-tight mb-4">Your Courses</h2>
          ...
          {/* Quick actions */}
          <h2 className="text-xl font-semibold tracking-tight leading-tight mb-4">Quick Actions</h2>
